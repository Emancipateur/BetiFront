...
<div className="wrapperImage wrapperImage1">
...
<div className="wrapperImage wrapperImage2">
...
<div className="wrapperImage wrapperImage3">
...
<div className="wrapperImage wrapperImage4">
...
<div className="wrapperImage wrapperImage5">
<p>
...
<div className="imageFiveHebergement"></div>
 ...
 <div className="wrapperImage wrapperImage6">
...
Chambres et suites sont climatisées et bénéficient des équipements suivants : bouilloire électrique, TV LCD avec chaînes satellite, Internet sans fil gratuit, bureau, terrasse avec table et fauteuils, salle de bain avec douche italienne, sèche cheveux et coffre de sécurité.
 ...
 <div className="wrapperImage wrapperImage7">

<p>

Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati maxime optio eligendi quasi deserunt, sit distinctio molestias voluptatibus voluptas esse tenetur nihil veniam facilis itaque at ex, corrupti nulla iure labore quos! Praesentium, beatae dolores!
 </p>

 <div className="imageSevenHebergement"></div>  
 </div> 
 <div className="wrapperImage wrapperImage8">

<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et doloremque, ut dicta maxime commodi atque laborum sed nemo tempore quia cupiditate necessitatibus esse, non enim officia, ipsum ducimus.
 </p>

 <div className="imageEightHebergement"></div>  
 </div> 
 <div className="wrapperImage wrapperImage9">

<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est et beatae nihil! Quia, aut porro quod veniam suscipit saepe laborum laboriosam consectetur itaque temporibus, corrupti vero aliquid unde.
 </p>

 <div className="imageNineHebergement"></div>  
 </div> 

<div className="boisNoir">
 <div className="handiIcon"></div>
