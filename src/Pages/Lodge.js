      ...
      <div className="logdeContent">
        <div className="lodgeShadows">
          ...
          <div className="lodgeWhereTofindUs">
            ...
            <p>
              Sur la RT1, quelques kilomètres avant Bourail un panneau au niveau
              d’un carrefour marqué d’une Grande croix blanche sur votre droite
              vous indique la route de LA TARAUDIERE. Cette route passe sur un
              petit pont et va vers l'hippodrome, lieu de la foire de Bourail.
              Vous passez devant la Tennessee Farm. En arrivant sur l’hippodrome
              continuez tout droit en laissant à droite la route qui va vers
              l’entrée de l'hippodrome (panneau Bourail sur votre gauche).
              Suivre la route sur 2 km jusqu'à une nouvelle bifurcation. Ne pas
              prendre la route qui tourne à gauche (retour vers Bourail),
              continuer tout droit. Vous rentrez dans la vallée COLOMINA.
            </p>
            <h4>De BOURAIL ou depuis le Nord :</h4>
            <p>
              Arrivés dans le village de Bourail, prendre à gauche la rue face à
              la mairie, direction LA TARAUDIERE. Après 300 m prendre à droite
              et suivre la route sur 4 km jusqu'à un carrefour de routes
              goudronnées (abri bus). Prendre à gauche. Vous rentrez dans la
              vallée COLOMINA.
            </p>
            <h4>Une fois dans la vallée COLOMINA :</h4>
            <p>
              Après 300 m, un panneau "Bétikuré" à gauche vous indique l'entrée
              de la piste. Continuez tout droit jusqu’à rencontrer les lanternes
              de pierre du Betikuré Parc Lodge. Vous pouvez être amenés à ouvrir
              2 barrières si du bétail a été mis à paître. Pensez à les refermer
              derrière vous.
            </p>
          </div>
        </div>
